<template>
  <el-container class="right_main_cont">
    <el-header class="right_main_header"
               style="height: 53px;">
      <!-- <el-row>
        <el-col :span="24"
                align="right">
      ...
      <el-row>
        <el-col :span="24">
          <ul class="main_tab_ul">
            <li v-for="(item,index) in tabColumn"
                :key="index"
                :class="index===tabIndex ? 'active': ''"
                @click="clickTab(item,index)">{{item.label}}</li>
          </ul>
        </el-col>
      </el-row>
    </el-header>
    <el-main class="right_main_main">
      <component :ref="isComponent"
                 :is="isComponent"
                 :info="info"
                 :patientInfo="patientInfo"></component>
    </el-main>
  </el-container>
</template>
<script>
// import bus from '@/assets/bus.js'
// import { deletePatient } from '@/service/api'
import basicInfo from '@/page/basicInfo/basicInfo'
// import screening from '@/page/screening/screening'
import examine from '@/page/examine/examine'
import drugPlan from '@/page/drugPlan/drugPlan'
export default {
  components: {
    basicInfo,
    // screening,
