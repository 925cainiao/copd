  ...
  <el-container class="slider_container">
    <el-header class="slider_form"
      ...
      <el-form :model="form"
        ...
        <el-form-item label=" 组织机构">
          ...
          <!-- <el-button type="primary">异常告知</el-button> -->
        </el-form-item>
        <el-form-item label="日  期">
          ...
          <el-date-picker v-model="form.date"
                          ...
                          class="slider_elform_date">
          </el-date-picker>
          <el-button type="primary"
                     @click="getList">患者列表</el-button>
        </el-form-item>
    ...
    <el-main class="slider_table">
      <el-table ref="sliderTable"
                ...
                :height="tableHeight"
                v-loading="isLoading">
        <el-table-column v-for="(item,index) in tableClumn"
                         :key="index"
                         :prop="item.prop"
                         :label="item.label"
                         align="center">
        ...
        <el-table-column label="操作"
                         width="80">
          <template slot-scope="scope">
            <i class="el-icon-edit-outline icon_style"
               @click="editBtn(scope.row)"></i>
            <i class="el-icon-delete icon_style"
               @click.stop="deleteBtn(scope.row)"></i>
          </template>
        </el-table-column>
      </el-table>
...
export default {
  ...
  methods: {
    ...
    handleRowClick (row) {
      ...
      // bus.$emit('queryPatientInfo', { info: this.patientInfo })
      this.$forceUpdate()
    },
    // 获取一个元素在数组中的下标
